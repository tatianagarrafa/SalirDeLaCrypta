...
public class LancerObjetMiniBossChamp : MonoBehaviour {
	...
	void Update () {
		...
		// Si le heros est vivant lance le projectile instantie de six cotes
		if (heros != null && charge<0) {
			...
			rbProj4.velocity = new Vector2 (6,3);
			...
			rbProj5.velocity = new Vector2 (-6,3);
			...
			rbProj6.velocity = new Vector2 (0,10);
